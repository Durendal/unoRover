# Class borrowed from: https://github.com/serdmanczyk/XBee_802.15.4_APIModeTutorial/blob/master/Python/XBee.py
import serial
...
class XBee():
	...
	def __init__(self, framework, serialport="COM5", baudrate=9600):
		self.serial = None
		self.serialport = serialport
		self.baudrate = baudrate
		self.fw = framework
		self.name = 'XBee'
		self.description = 'Library to wrapper functions for XBee'

	def setup(self):
		self.serial = serial.Serial(port=serialport, baudrate=self.baudrate)
